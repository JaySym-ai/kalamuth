      ...
      <div className="relative z-10 container mx-auto px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl md:text-2xl text-gray-300 mb-12 leading-relaxed">
            Join thousands of Ludus Masters in the ultimate gladiator empire.
            <br />
            <span className="text-amber-400 font-semibold">
              The arena calls for its next champion.
            </span>
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-16">
            {[
              { icon: "🎁", title: "Exclusive Rewards", description: "Early access bonuses" },
              { icon: "⚡", title: "Priority Access", description: "Be first in the arena" },
              { icon: "👑", title: "Founder Status", description: "Special recognition forever" },
            ].map((benefit, index) => (
              <div
                key={index}
