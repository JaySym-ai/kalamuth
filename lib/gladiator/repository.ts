...
import type { NormalizedGladiator } from "@/types/gladiator";
...
export const GLADIATOR_SELECT_FIELDS = 
  "id, ludusId, serverId, name, surname, avatarUrl, birthCity, health, current_health, stats, personality, backstory, lifeGoal, likes, dislikes, createdAt, updatedAt, injury, injuryTimeLeftHours, sickness, handicap, uniquePower, weakness, fear, physicalCondition, notableHistory, alive, rankingPoints";
